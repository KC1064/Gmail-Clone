...
const Navbar = () => {
  return (
    <div className="h-16 w-full flex items-center pt-1 gap-10">
      ...
      <div className="w-[820px] h-[48px] flex items-center bg-[#EAF1FB] rounded-full">
        <div className="flex h-[46px] w-[720px] items-center">
          ...
          <input
            type="text"
            className="w-[550px] bg-[#EAF1FB] pl-2 text-lg"
            placeholder="Search mail"
          />
        </div>
      </div>
      <div className="flex items-center gap-1">
        <div className="h-[40px] w-[40px] flex items-center justify-center  hover:bg-gray-200 hover:rounded-full">
